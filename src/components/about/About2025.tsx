...
const StatCard = ({ number, description }: { number: string, description: string }) => {
    return (
        <div className="bg-white/40 backdrop-blur-sm p-6 sm:p-8 rounded-[24px] border border-white/60 shadow-sm hover:shadow-lg transition-all duration-300 group">
            <h3 className="text-3xl sm:text-4xl font-bold text-[#2d8bba] mb-2 group-hover:scale-110 transition-transform flex items-baseline gap-1">
                {number}
            </h3>
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fadeIn">
                        <span className="text-[#2d8bba] font-bold uppercase tracking-widest text-sm mb-4 block">Nhìn lại SEAS 2025</span>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#004d61] mb-8 roboto-slab drop-shadow-sm">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed mb-10 font-medium">
                            Năm 2025 đánh dấu bước khởi đầu rực rỡ của cộng đồng SEAS tại Quảng Bình. Với chủ đề <span className="text-[#2d8bba] font-bold">Trí tuệ Nhân tạo & Ứng dụng</span>, chúng tôi đã chứng kiến những bước tiến vượt bậc và sự trưởng thành của 43 học viên xuất sắc.
                        </p>
                    ...
                    <div className="relative group animate-fadeInUp">
                        <div className="absolute inset-0 bg-blue-100 rounded-[40px] rotate-3 group-hover:rotate-1 transition-transform duration-500"></div>
                        <div className="relative bg-white p-4 rounded-[40px] shadow-2xl overflow-hidden border border-blue-50">
                            ...
                            <div className="p-6 sm:p-8">
                                <span className="text-xs font-bold text-[#2d8bba] uppercase mb-2 block">{impactData.card.subtitle}</span>
                                <h3 className="text-xl sm:text-2xl font-bold text-[#004d61] mb-4">{impactData.card.title}</h3>
                                <a
