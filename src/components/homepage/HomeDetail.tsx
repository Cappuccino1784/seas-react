    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#F0F8FB] via-white to-[#E6F3F8] py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold text-[#004d61] mb-4 px-2 roboto-slab">
            Khám Phá SEAS
          </h2>
          <p className="text-xs sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
            Tìm hiểu thêm về chương trình, đội ngũ và cách thức tham gia trại hè SEAS.
          </p>
        </div>
