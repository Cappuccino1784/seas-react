...
export const projects: Record<"SEAS 2025" | "SEAS 2026", Project[]> = {
  "SEAS 2025": [
    // Nhóm 1 - PHÂN LOẠI CÁ TRONG THỜI GIAN THỰC BẰNG AI
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 1. PHÂN LOẠI CÁ TRONG THỜI GIAN THỰC BẰNG AI.pdf",
    ...
    // Nhóm 3 - MẠNG NƠ-RON CHO VẬT LÝ NHIỀU HẠT LƯỢNG TỬ
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 3. MẠNG NƠ-RON CHO VẬT LÝ NHIỀU HẠT LƯỢNG TỬ.pdf",
    ...
    // Nhóm 4 - ỨNG DỤNG HỌC KHÔNG GIÁM SÁT TRONG XỬ LÝ ẢNH MƯA
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 4. ỨNG DỤNG HỌC KHÔNG GIÁM SÁT TRONG XỬ LÝ ẢNH MƯA.pdf",
    ...
    // Nhóm 5 - MẠNG NƠ-RON ĐỒ THỊ VÀ TÍNH DỄ BỊ TỔN THƯƠNG TRONG ỨNG DỤNG THỰC TẾ
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 5. MẠNG NƠ-RON ĐỒ THỊ VÀ TÍNH DỄ BỊ TỔN THƯƠNG TRONG ỨNG DỤNG THỰC TẾ.pdf",
    ...
    // Nhóm 6 - MÔ HÌNH DỰ BÁO LŨ LỤT Ở MIỀN TRUNG
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 6. MÔ HÌNH DỰ BÁO LŨ LỤT Ở MIỀN TRUNG.pdf",
    ...
    // Nhóm 7 - AI CHO TẦNG VẬT LÝ CỦA MẠNG 6G
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 7. AI CHO TẦNG VẬT LÝ CỦA MẠNG 6G.pdf",
    ...
    // Nhóm 8 - NHẬN DIỆN MÓN ĂN QUA HÌNH ẢNH VÀ VĂN BẢN
    {
      ...
      slidePdf: "/pdfs/PROJECTS 2025/Nhóm 8. NHẬN DIỆN MÓN ĂN QUA HÌNH ẢNH VÀ VĂN BẢN.pdf",
