...
export const staffMembers2025: StaffMember[] = [
  ...
  {
    slug: "huynh-vu-khoi-nguyen-2025",
  ...
  {
    slug: "chau-nguyen-to-trinh-2025",
...
export const staffMembers2026: StaffMember[] = [
  {
    ...
    role: "Ban tổ chức tại địa phương",
    bio: "Thầy Giáo tại Trường Chuyên Võ Nguyên Giáp",
    image: "/images/team/2026/le-anh-vu-2026.jpg",
    profileSummary: "Thầy Giáo tại Trường Chuyên Võ Nguyên Giáp",
    highlights: [],
    quote: "",
    links: [],
  ...
  {
    slug: "nguyen-thi-hai-yen-2026",
    name: "Nguyễn Thị Hải Yến",
    role: "Ban tổ chức tại địa phương",
    bio: "Hiệu trưởng tại Trường Chuyên Võ Nguyên Giáp",
    image: "/images/team/2026/nguyen-thi-hai-yen-2026.jpg",
    profileSummary: "Hiệu trưởng tại Trường Chuyên Võ Nguyên Giáp",
    highlights: [],
    quote: "",
    links: [],
  ...
  },
  {
    ...
    bio: "PhD Student in Robotics - MBZUAI",
    image: "/images/team/2026/quang-pham-2026.png",
    profileSummary: "PhD Student in Robotics - MBZUAI",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "bui-minh-thai-2026",
    name: "Bùi Minh Thái",
    role: "Event planner",
    bio: "Cử nhân khoa học máy tính - Đại học Bách Khoa Hà Nội",
    image: "/images/team/2026/bui-minh-thai-2026.jpg",
    profileSummary: "Cử nhân khoa học máy tính - Đại học Bách Khoa Hà Nội",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "dao-thi-quynh-anh-2026",
    name: "Đào Thị Quỳnh Anh",
    role: "BTC",
    bio: "Cử nhân Kinh tế học và Âm nhạc - Amherst College",
    image: "/images/team/2026/dao-thi-quynh-anh-2026.jpg",
    profileSummary: "Cử nhân Kinh tế học và Âm nhạc - Amherst College",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-nhu-quynh-2026",
    name: "Nguyễn Như Quỳnh",
    role: "BTC",
    bio: "Ngành Bác sĩ Y khoa - Đại học Y Hà Nội",
    image: "/images/team/2026/nguyen-nhu-quynh-2026.jpg",
    profileSummary: "Cử nhân ngành Bác sĩ Y khoa - Đại học Y Hà Nội",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-duc-anh-minh-2026",
    name: "Nguyễn Đức Anh Minh",
    role: "Website Developer, Designer",
    bio: "Cử nhân An ninh mạng - Đại học Bách Khoa Hà Nội",
    image: "/images/team/2026/nguyen-duc-anh-minh-2026.JPG",
    profileSummary: "Cử nhân An ninh mạng - Đại học Bách Khoa Hà Nội",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-bao-ngoc-2026",
    name: "Nguyễn Bảo Ngọc",
    role: "Designer",
    bio: "Chuyên Anh - THPT Chuyên Đại học Sư Phạm",
    image: "/images/team/2026/nguyen-bao-ngoc-2026.jpg",
    profileSummary: "Chuyên Anh - THPT Chuyên Đại học Sư Phạm",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "dang-gia-phong-2026",
    name: "Đặng Gia Phong",
    role: "Designer",
    bio: "Cử nhân ngành Bác sĩ Y khoa - Đại học Y Hà Nội",
    image: "/images/team/2026/dang-gia-phong-2026.jpg",
    profileSummary: "Cử nhân ngành Bác sĩ Y khoa - Đại học Y Hà Nội",
    highlights: [],
    quote: "",
    links: [],
  ...
  },
  {
    ...
    bio: "Cử nhân Kinh doanh quốc tế - UEH",
    image: "/images/team/2026/hoang-thi-phuc-nguyen-2026.jpg",
    profileSummary: "Cử nhân Kinh doanh quốc tế - UEH",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-vu-anh-ngoc-2026",
    name: "Nguyễn Vũ Ánh Ngọc",
    role: "Teaching Staff",
    bio: "Research Assistant, VinUniversity",
    image: "/images/team/2026/nguyen-vu-anh-ngoc-2026.jpg",
    profileSummary: "Research Assistant, VinUniversity",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "tran-thi-tam-phu-2026",
    name: "Trần Thị Tâm Phú",
    role: "Teaching Staff",
    bio: "Đại học Fulbright Việt Nam",
    image: "/images/team/2026/tran-thi-tam-phu-2026.png",
    profileSummary: "Đại học Fulbright Việt Nam",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-thi-nhu-quynh-2026",
    name: "Nguyễn Thị Như Quỳnh",
    role: "Teaching Staff",
    bio: "Cử nhân Khoa học máy tính, Trường Đại học Công nghệ Thông tin, ĐHQG TP.HCM",
    image: "/images/team/2026/nguyen-thi-nhu-quynh-2026.jpg",
    profileSummary: "Cử nhân Khoa học máy tính, Trường Đại học Công nghệ Thông tin, ĐHQG TP.HCM",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-thi-ha-chi-2026",
    name: "Nguyễn Thị Hà Chi",
    role: "Teaching Staff",
    bio: "Nghiên cứu tại Viện nghiên cứu và ứng dụng trí tuệ nhân tạo (AI4LIFE)",
    image: "/images/team/2026/nguyen-thi-ha-chi-2026.jpg",
    profileSummary: "Nghiên cứu tại Viện nghiên cứu và ứng dụng trí tuệ nhân tạo (AI4LIFE)",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "chau-nguyen-to-trinh-2026",
    name: "Châu Nguyễn Tố Trinh",
    role: "Teaching Staff",
    bio: "Cử nhân Khoa học máy tính - Trường Đại học Công nghệ - ĐHQGHN",
    image: "/images/team/2026/chau-nguyen-to-trinh-2026.jpg",
    profileSummary: "Cử nhân Khoa học máy tính - Trường Đại học Công nghệ - ĐHQGHN",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-phuong-trang-2026",
    name: "Nguyễn Phương Trang",
    role: "Teaching Staff",
    bio: "Nghiên cứu viên tại Avitech",
    image: "/images/team/2026/nguyen-phuong-trang-2026.jpg",
    profileSummary: "Nghiên cứu viên tại Avitech",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "ngo-xuan-thuy-2026",
    name: "Ngô Xuân Thùy",
    role: "Teaching Staff",
    bio: "Cử nhân Thống kê Ứng dụng, trường Đại học Quốc Tế, ĐHQG - HCM",
    image: "/images/team/2026/ngo-xuan-thuy-2026.jpg",
    profileSummary: "Cử nhân Thống kê Ứng dụng, trường Đại học Quốc Tế, ĐHQG - HCM",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-phu-vinh-2026",
    name: "Nguyễn Phú Vinh",
    role: "Teaching Staff",
    bio: "Ph.D. in NLP, MBUAI (incoming); MSc in Computer Science, Uppsala University",
    image: "/images/team/2026/nguyen-phu-vinh-2026.jpg",
    profileSummary: "Ph.D. in NLP, MBUAI (incoming); MSc in Computer Science, Uppsala University",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "tran-ta-quang-minh-2026",
    name: "Trần Tạ Quang Minh",
    role: "Teaching Staff",
    bio: "Cử nhân Trí tuệ Nhân tạo - Đại học Khoa học Tự Nhiên",
    image: "/images/team/2026/tran-ta-quang-minh-2026.jpg",
    profileSummary: "Cử nhân Trí tuệ Nhân tạo - Đại học Khoa học Tự Nhiên",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-tiet-nguyen-khoi-2026",
    name: "Nguyễn Tiết Nguyên Khôi",
    role: "Teaching Staff",
    bio: "Research Officer, Nanyang Technological University",
    image: "/images/team/2026/nguyen-tiet-nguyen-khoi-2026.jpg",
    profileSummary: "Research Officer, Nanyang Technological University",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-phuc-luong-2026",
    name: "Nguyễn Phúc Lương",
    role: "Teaching Staff",
    bio: "Cử nhân Khoa Học Máy Tính, University of Alabama",
    image: "/images/team/2026/nguyen-phuc-luong-2026.jpg",
    profileSummary: "Cử nhân Khoa Học Máy Tính, University of Alabama",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-xuan-minh-duc-2026",
    name: "Nguyễn Xuân Minh Đức",
    role: "Teaching Staff",
    bio: "Kĩ sư tài năng Khoa học máy tính, Trường Đại học Bách khoa Hà Nội",
    image: "/images/team/2026/nguyen-xuan-minh-duc-2026.jpg",
    profileSummary: "Kĩ sư tài năng Khoa học máy tính, Trường Đại học Bách khoa Hà Nội",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "tran-hai-nam-2026",
    name: "Trần Hải Nam",
    role: "Teaching Staff",
    bio: "Data Scientist, Techcombank",
    image: "/images/team/2026/tran-hai-nam-2026.jpg",
    profileSummary: "Data Scientist, Techcombank",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "do-chau-tuan-2026",
    name: "Đỗ Châu Tuấn",
    role: "Teaching Staff",
    bio: "Cử nhân Toán học, Budapest University of Technology and Economics",
    image: "/images/team/2026/do-chau-tuan-2026.jpg",
    profileSummary: "Cử nhân Toán học, Budapest University of Technology and Economics",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "alexandro-garces-2026",
    name: "Alexandro Garces",
    role: "Teaching Staff",
    bio: "Massachusetts Institute of Technology",
    image: "/images/team/2026/alexandro-garces-2026.png",
    profileSummary: "Massachusetts Institute of Technology",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
  ...
  {
    slug: "nguyen-thanh-luan-2026",
    name: "Nguyễn Thành Luân",
    role: "Teaching Staff",
    bio: "Giảng viên tại Trường Đại học Công nghệ Thông tin, Đại học Quốc Gia TP. HCM",
    image: "/images/team/2026/nguyen-thanh-luan-2026.jpg",
    profileSummary: "Giảng viên tại Trường Đại học Công nghệ Thông tin, Đại học Quốc Gia TP. HCM",
    highlights: [],
    quote: "",
    links: [],
    group: "member",
